    ...
    return (
        <div className="space-y-6">
            <SectionHeader
                ...
                subtitle="Scanează galaxia de afaceri românești"
            />
            ...
            <form onSubmit={handleSearch} className="flex gap-2">
                <div className="relative flex-1">
                    ...
                    <input
                        type="text"
                        placeholder="Denumire firmă, CUI, sau cuvinte cheie..."
                        value={filters.query || ""}
            ...
            {/* Filtre Avansate — mereu vizibile */}
            <div className="card-cosmic">
                <div className="mb-4 flex items-center justify-between">
                    <h3 className="font-orbitron text-sm font-semibold tracking-wide text-slate-700 dark:text-slate-200">Filtre Avansate</h3>
                    <button onClick={clearFilters} className="font-rajdhani text-sm font-semibold uppercase tracking-wider text-nebula-500 hover:text-nebula-700">
                        Resetează
                    </button>
                </div>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Județ</label>
                        <select
                            value={filters.judet || ""}
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Stare Firmă</label>
                        <select
                            value={filters.stare || ""}
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Cifra de Afaceri Min</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Cifra de Afaceri Max</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Angajați Min</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Angajați Max</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Cod CAEN</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Țară</label>
                        <select
                            value={filters.tara || ""}
                    ...
                    <div className="sm:col-span-2">
                        <label className="block font-rajdhani text-sm font-semibold uppercase tracking-wider text-slate-400">Administrator</label>
                        <input
                            type="text"
